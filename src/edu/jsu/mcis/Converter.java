...
public class Converter {
    ...
    */
    public static final int ID_NUM_FIELDS = 5;
    ...
    public static String jsonToCsv(String jsonString) {
        ...
        try {
            ...
            ArrayList<String> colHeadersAList = (ArrayList)jsonObject.get("colHeaders");
            ArrayList<String> rowHeadersAList = (ArrayList)jsonObject.get("rowHeaders");
            ...
            String [] colHeaders = getStringArray(colHeadersAList);
            String [] rowHeaders = getStringArray(rowHeadersAList);
            String [] data = getStringArray(dataAList);
            ...
            for(int i = 0; i < rowHeaders.length; ++i){
                String [] csvData = new String [ID_NUM_FIELDS];
